...
// By Addy Osmani
Modernizr.addTest('microdata', !!(document['getItems']));// async script
// By Theodoor van Donge
Modernizr.addTest('scriptasync', 'async' in document.createElement('script'));// data uri test.
...
// By Addy Osmani
Modernizr.addTest('getusermedia', !!('getUserMedia' in navigator));// Animated PNG
